...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched portui! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "portui Documentation",
            description: "A comprehensive guide to portui",
